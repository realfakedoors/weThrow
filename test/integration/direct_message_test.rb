...
class DirectMessageTest < ActionDispatch::IntegrationTest
  ...
  test "Direct messages" do
    ...
    assert_difference 'DirectMessage.count', 1 do
      post '/api/direct_messages', params: @dm_params
    end
    ...
    assert_no_difference 'DirectMessage.count' do
      post '/api/direct_messages', params: bad_dm_params
    end
    bad_dm_params = @dm_params.deep_dup
    ...
    assert_difference 'Message.count', -2 do
      delete "/api/direct_messages/#{new_dm_id}"
    end
  ...
  test "Admin messages" do
    ...
    sign_in @user
    post '/api/direct_messages', params: ticket_params
    sign_in @admin
    get "/api/direct_messages", params: {inbox: "admin"}
    assert_response :success
